...
<p>
<img src="https://i.imgur.com/3DJAQ1g.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
<p>
In this step you can see that in this picture that we have download and installed all of the prerequs. Changed privacy settings set up our username and password changed persmission back to read only from having full access. 
</p>
<br />
